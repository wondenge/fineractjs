...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new ApacheFineract.GetFixedDepositProductsCurrency();
  });
  ...
  describe('GetFixedDepositProductsCurrency', function() {
    it('should create an instance of GetFixedDepositProductsCurrency', function() {
      // uncomment below and update the code to test GetFixedDepositProductsCurrency
      //var instane = new ApacheFineract.GetFixedDepositProductsCurrency();
      //expect(instance).to.be.a(ApacheFineract.GetFixedDepositProductsCurrency);
    });
