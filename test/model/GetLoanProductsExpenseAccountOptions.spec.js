...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new ApacheFineract.GetLoanProductsExpenseAccountOptions();
  });
  ...
  describe('GetLoanProductsExpenseAccountOptions', function() {
    it('should create an instance of GetLoanProductsExpenseAccountOptions', function() {
      // uncomment below and update the code to test GetLoanProductsExpenseAccountOptions
      //var instane = new ApacheFineract.GetLoanProductsExpenseAccountOptions();
      //expect(instance).to.be.a(ApacheFineract.GetLoanProductsExpenseAccountOptions);
    });
