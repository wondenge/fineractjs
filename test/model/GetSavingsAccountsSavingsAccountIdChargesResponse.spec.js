...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new ApacheFineract.GetSavingsAccountsSavingsAccountIdChargesResponse();
  });
  ...
  describe('GetSavingsAccountsSavingsAccountIdChargesResponse', function() {
    it('should create an instance of GetSavingsAccountsSavingsAccountIdChargesResponse', function() {
      // uncomment below and update the code to test GetSavingsAccountsSavingsAccountIdChargesResponse
      //var instane = new ApacheFineract.GetSavingsAccountsSavingsAccountIdChargesResponse();
      //expect(instance).to.be.a(ApacheFineract.GetSavingsAccountsSavingsAccountIdChargesResponse);
    });
