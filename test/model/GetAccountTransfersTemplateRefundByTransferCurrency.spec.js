...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new ApacheFineract.GetAccountTransfersTemplateRefundByTransferCurrency();
  });
  ...
  describe('GetAccountTransfersTemplateRefundByTransferCurrency', function() {
    it('should create an instance of GetAccountTransfersTemplateRefundByTransferCurrency', function() {
      // uncomment below and update the code to test GetAccountTransfersTemplateRefundByTransferCurrency
      //var instane = new ApacheFineract.GetAccountTransfersTemplateRefundByTransferCurrency();
      //expect(instance).to.be.a(ApacheFineract.GetAccountTransfersTemplateRefundByTransferCurrency);
    });
