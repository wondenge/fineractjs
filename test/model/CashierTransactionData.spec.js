...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new ApacheFineract.CashierTransactionData();
  });
  ...
  describe('CashierTransactionData', function() {
    it('should create an instance of CashierTransactionData', function() {
      // uncomment below and update the code to test CashierTransactionData
      //var instane = new ApacheFineract.CashierTransactionData();
      //expect(instance).to.be.a(ApacheFineract.CashierTransactionData);
    });
