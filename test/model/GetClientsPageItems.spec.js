...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new ApacheFineract.GetClientsPageItems();
  });
  ...
  describe('GetClientsPageItems', function() {
    it('should create an instance of GetClientsPageItems', function() {
      // uncomment below and update the code to test GetClientsPageItems
      //var instane = new ApacheFineract.GetClientsPageItems();
      //expect(instance).to.be.a(ApacheFineract.GetClientsPageItems);
    });
