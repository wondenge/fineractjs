...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new ApacheFineract.GetSelfSavingsAccountsAccountIdChargesResponse();
  });
  ...
  describe('GetSelfSavingsAccountsAccountIdChargesResponse', function() {
    it('should create an instance of GetSelfSavingsAccountsAccountIdChargesResponse', function() {
      // uncomment below and update the code to test GetSelfSavingsAccountsAccountIdChargesResponse
      //var instane = new ApacheFineract.GetSelfSavingsAccountsAccountIdChargesResponse();
      //expect(instance).to.be.a(ApacheFineract.GetSelfSavingsAccountsAccountIdChargesResponse);
    });
