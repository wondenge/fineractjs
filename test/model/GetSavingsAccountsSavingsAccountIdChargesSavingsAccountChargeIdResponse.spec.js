...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new ApacheFineract.GetSavingsAccountsSavingsAccountIdChargesSavingsAccountChargeIdResponse();
  });
  ...
  describe('GetSavingsAccountsSavingsAccountIdChargesSavingsAccountChargeIdResponse', function() {
    it('should create an instance of GetSavingsAccountsSavingsAccountIdChargesSavingsAccountChargeIdResponse', function() {
      // uncomment below and update the code to test GetSavingsAccountsSavingsAccountIdChargesSavingsAccountChargeIdResponse
      //var instane = new ApacheFineract.GetSavingsAccountsSavingsAccountIdChargesSavingsAccountChargeIdResponse();
      //expect(instance).to.be.a(ApacheFineract.GetSavingsAccountsSavingsAccountIdChargesSavingsAccountChargeIdResponse);
    });
