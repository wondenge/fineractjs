...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new ApacheFineract.GetSavingsProductsAssetAccountOptions();
  });
  ...
  describe('GetSavingsProductsAssetAccountOptions', function() {
    it('should create an instance of GetSavingsProductsAssetAccountOptions', function() {
      // uncomment below and update the code to test GetSavingsProductsAssetAccountOptions
      //var instane = new ApacheFineract.GetSavingsProductsAssetAccountOptions();
      //expect(instance).to.be.a(ApacheFineract.GetSavingsProductsAssetAccountOptions);
    });
