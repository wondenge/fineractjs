...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new ApacheFineract.GetProductsAssetAccountOptions();
  });
  ...
  describe('GetProductsAssetAccountOptions', function() {
    it('should create an instance of GetProductsAssetAccountOptions', function() {
      // uncomment below and update the code to test GetProductsAssetAccountOptions
      //var instane = new ApacheFineract.GetProductsAssetAccountOptions();
      //expect(instance).to.be.a(ApacheFineract.GetProductsAssetAccountOptions);
    });
