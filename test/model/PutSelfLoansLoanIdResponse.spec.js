...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new ApacheFineract.PutSelfLoansLoanIdResponse();
  });
  ...
  describe('PutSelfLoansLoanIdResponse', function() {
    it('should create an instance of PutSelfLoansLoanIdResponse', function() {
      // uncomment below and update the code to test PutSelfLoansLoanIdResponse
      //var instane = new ApacheFineract.PutSelfLoansLoanIdResponse();
      //expect(instance).to.be.a(ApacheFineract.PutSelfLoansLoanIdResponse);
    });
