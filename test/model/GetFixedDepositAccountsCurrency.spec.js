...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new ApacheFineract.GetFixedDepositAccountsCurrency();
  });
  ...
  describe('GetFixedDepositAccountsCurrency', function() {
    it('should create an instance of GetFixedDepositAccountsCurrency', function() {
      // uncomment below and update the code to test GetFixedDepositAccountsCurrency
      //var instane = new ApacheFineract.GetFixedDepositAccountsCurrency();
      //expect(instance).to.be.a(ApacheFineract.GetFixedDepositAccountsCurrency);
    });
