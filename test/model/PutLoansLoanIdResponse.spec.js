...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new ApacheFineract.PutLoansLoanIdResponse();
  });
  ...
  describe('PutLoansLoanIdResponse', function() {
    it('should create an instance of PutLoansLoanIdResponse', function() {
      // uncomment below and update the code to test PutLoansLoanIdResponse
      //var instane = new ApacheFineract.PutLoansLoanIdResponse();
      //expect(instance).to.be.a(ApacheFineract.PutLoansLoanIdResponse);
    });
