...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new ApacheFineract.GetSelfClientsSavingsAccountsCurrency();
  });
  ...
  describe('GetSelfClientsSavingsAccountsCurrency', function() {
    it('should create an instance of GetSelfClientsSavingsAccountsCurrency', function() {
      // uncomment below and update the code to test GetSelfClientsSavingsAccountsCurrency
      //var instane = new ApacheFineract.GetSelfClientsSavingsAccountsCurrency();
      //expect(instance).to.be.a(ApacheFineract.GetSelfClientsSavingsAccountsCurrency);
    });
