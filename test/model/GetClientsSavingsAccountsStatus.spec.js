...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new ApacheFineract.GetClientsSavingsAccountsStatus();
  });
  ...
  describe('GetClientsSavingsAccountsStatus', function() {
    it('should create an instance of GetClientsSavingsAccountsStatus', function() {
      // uncomment below and update the code to test GetClientsSavingsAccountsStatus
      //var instane = new ApacheFineract.GetClientsSavingsAccountsStatus();
      //expect(instance).to.be.a(ApacheFineract.GetClientsSavingsAccountsStatus);
    });
