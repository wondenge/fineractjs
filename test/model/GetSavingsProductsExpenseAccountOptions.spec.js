...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new ApacheFineract.GetSavingsProductsExpenseAccountOptions();
  });
  ...
  describe('GetSavingsProductsExpenseAccountOptions', function() {
    it('should create an instance of GetSavingsProductsExpenseAccountOptions', function() {
      // uncomment below and update the code to test GetSavingsProductsExpenseAccountOptions
      //var instane = new ApacheFineract.GetSavingsProductsExpenseAccountOptions();
      //expect(instance).to.be.a(ApacheFineract.GetSavingsProductsExpenseAccountOptions);
    });
