...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new ApacheFineract.GetRecurringDepositAccountsTimeline();
  });
  ...
  describe('GetRecurringDepositAccountsTimeline', function() {
    it('should create an instance of GetRecurringDepositAccountsTimeline', function() {
      // uncomment below and update the code to test GetRecurringDepositAccountsTimeline
      //var instane = new ApacheFineract.GetRecurringDepositAccountsTimeline();
      //expect(instance).to.be.a(ApacheFineract.GetRecurringDepositAccountsTimeline);
    });
