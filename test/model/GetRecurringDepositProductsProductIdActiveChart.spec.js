...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new ApacheFineract.GetRecurringDepositProductsProductIdActiveChart();
  });
  ...
  describe('GetRecurringDepositProductsProductIdActiveChart', function() {
    it('should create an instance of GetRecurringDepositProductsProductIdActiveChart', function() {
      // uncomment below and update the code to test GetRecurringDepositProductsProductIdActiveChart
      //var instane = new ApacheFineract.GetRecurringDepositProductsProductIdActiveChart();
      //expect(instance).to.be.a(ApacheFineract.GetRecurringDepositProductsProductIdActiveChart);
    });
