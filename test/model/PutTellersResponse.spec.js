...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new ApacheFineract.PutTellersResponse();
  });
  ...
  describe('PutTellersResponse', function() {
    it('should create an instance of PutTellersResponse', function() {
      // uncomment below and update the code to test PutTellersResponse
      //var instane = new ApacheFineract.PutTellersResponse();
      //expect(instance).to.be.a(ApacheFineract.PutTellersResponse);
    });
