...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new ApacheFineract.GetLoansLoanIdChargesChargeIdResponse();
  });
  ...
  describe('GetLoansLoanIdChargesChargeIdResponse', function() {
    it('should create an instance of GetLoansLoanIdChargesChargeIdResponse', function() {
      // uncomment below and update the code to test GetLoansLoanIdChargesChargeIdResponse
      //var instane = new ApacheFineract.GetLoansLoanIdChargesChargeIdResponse();
      //expect(instance).to.be.a(ApacheFineract.GetLoansLoanIdChargesChargeIdResponse);
    });
