...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new ApacheFineract.GetLoanProductsCurrency();
  });
  ...
  describe('GetLoanProductsCurrency', function() {
    it('should create an instance of GetLoanProductsCurrency', function() {
      // uncomment below and update the code to test GetLoanProductsCurrency
      //var instane = new ApacheFineract.GetLoanProductsCurrency();
      //expect(instance).to.be.a(ApacheFineract.GetLoanProductsCurrency);
    });
