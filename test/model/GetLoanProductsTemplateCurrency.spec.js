...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new ApacheFineract.GetLoanProductsTemplateCurrency();
  });
  ...
  describe('GetLoanProductsTemplateCurrency', function() {
    it('should create an instance of GetLoanProductsTemplateCurrency', function() {
      // uncomment below and update the code to test GetLoanProductsTemplateCurrency
      //var instane = new ApacheFineract.GetLoanProductsTemplateCurrency();
      //expect(instance).to.be.a(ApacheFineract.GetLoanProductsTemplateCurrency);
    });
