...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new ApacheFineract.GetProductsCharges();
  });
  ...
  describe('GetProductsCharges', function() {
    it('should create an instance of GetProductsCharges', function() {
      // uncomment below and update the code to test GetProductsCharges
      //var instane = new ApacheFineract.GetProductsCharges();
      //expect(instance).to.be.a(ApacheFineract.GetProductsCharges);
    });
