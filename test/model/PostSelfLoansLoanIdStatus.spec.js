...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new ApacheFineract.PostSelfLoansLoanIdStatus();
  });
  ...
  describe('PostSelfLoansLoanIdStatus', function() {
    it('should create an instance of PostSelfLoansLoanIdStatus', function() {
      // uncomment below and update the code to test PostSelfLoansLoanIdStatus
      //var instane = new ApacheFineract.PostSelfLoansLoanIdStatus();
      //expect(instance).to.be.a(ApacheFineract.PostSelfLoansLoanIdStatus);
    });
