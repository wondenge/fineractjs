...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new ApacheFineract.GetFixedDepositAccountsAccountChart();
  });
  ...
  describe('GetFixedDepositAccountsAccountChart', function() {
    it('should create an instance of GetFixedDepositAccountsAccountChart', function() {
      // uncomment below and update the code to test GetFixedDepositAccountsAccountChart
      //var instane = new ApacheFineract.GetFixedDepositAccountsAccountChart();
      //expect(instance).to.be.a(ApacheFineract.GetFixedDepositAccountsAccountChart);
    });
