...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new ApacheFineract.InteropIdentifierAccountResponseData();
  });
  ...
  describe('InteropIdentifierAccountResponseData', function() {
    it('should create an instance of InteropIdentifierAccountResponseData', function() {
      // uncomment below and update the code to test InteropIdentifierAccountResponseData
      //var instane = new ApacheFineract.InteropIdentifierAccountResponseData();
      //expect(instance).to.be.a(ApacheFineract.InteropIdentifierAccountResponseData);
    });
