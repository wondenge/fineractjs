...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new ApacheFineract.PutUsersUserIdResponse();
  });
  ...
  describe('PutUsersUserIdResponse', function() {
    it('should create an instance of PutUsersUserIdResponse', function() {
      // uncomment below and update the code to test PutUsersUserIdResponse
      //var instane = new ApacheFineract.PutUsersUserIdResponse();
      //expect(instance).to.be.a(ApacheFineract.PutUsersUserIdResponse);
    });
