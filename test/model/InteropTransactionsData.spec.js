...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new ApacheFineract.InteropTransactionsData();
  });
  ...
  describe('InteropTransactionsData', function() {
    it('should create an instance of InteropTransactionsData', function() {
      // uncomment below and update the code to test InteropTransactionsData
      //var instane = new ApacheFineract.InteropTransactionsData();
      //expect(instance).to.be.a(ApacheFineract.InteropTransactionsData);
    });
