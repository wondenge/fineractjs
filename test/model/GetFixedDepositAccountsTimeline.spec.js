...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new ApacheFineract.GetFixedDepositAccountsTimeline();
  });
  ...
  describe('GetFixedDepositAccountsTimeline', function() {
    it('should create an instance of GetFixedDepositAccountsTimeline', function() {
      // uncomment below and update the code to test GetFixedDepositAccountsTimeline
      //var instane = new ApacheFineract.GetFixedDepositAccountsTimeline();
      //expect(instance).to.be.a(ApacheFineract.GetFixedDepositAccountsTimeline);
    });
