...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new ApacheFineract.GetRunReportColumnHeaders();
  });
  ...
  describe('GetRunReportColumnHeaders', function() {
    it('should create an instance of GetRunReportColumnHeaders', function() {
      // uncomment below and update the code to test GetRunReportColumnHeaders
      //var instane = new ApacheFineract.GetRunReportColumnHeaders();
      //expect(instance).to.be.a(ApacheFineract.GetRunReportColumnHeaders);
    });
