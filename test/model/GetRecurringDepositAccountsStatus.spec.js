...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new ApacheFineract.GetRecurringDepositAccountsStatus();
  });
  ...
  describe('GetRecurringDepositAccountsStatus', function() {
    it('should create an instance of GetRecurringDepositAccountsStatus', function() {
      // uncomment below and update the code to test GetRecurringDepositAccountsStatus
      //var instane = new ApacheFineract.GetRecurringDepositAccountsStatus();
      //expect(instance).to.be.a(ApacheFineract.GetRecurringDepositAccountsStatus);
    });
    ...
    it('should have the property prematureClosed (base name: "prematureClosed")', function() {
      // uncomment below and update the code to test the property prematureClosed
      //var instane = new ApacheFineract.GetRecurringDepositAccountsStatus();
      //expect(instance).to.be();
    });
