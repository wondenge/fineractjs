...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new ApacheFineract.InteropTransactionRequestData();
  });
  ...
  describe('InteropTransactionRequestData', function() {
    it('should create an instance of InteropTransactionRequestData', function() {
      // uncomment below and update the code to test InteropTransactionRequestData
      //var instane = new ApacheFineract.InteropTransactionRequestData();
      //expect(instance).to.be.a(ApacheFineract.InteropTransactionRequestData);
    });
