...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new ApacheFineract.GetInterestRateChartsResponse();
  });
  ...
  describe('GetInterestRateChartsResponse', function() {
    it('should create an instance of GetInterestRateChartsResponse', function() {
      // uncomment below and update the code to test GetInterestRateChartsResponse
      //var instane = new ApacheFineract.GetInterestRateChartsResponse();
      //expect(instance).to.be.a(ApacheFineract.GetInterestRateChartsResponse);
    });
