...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new ApacheFineract.GetAccountsChargesCurrency();
  });
  ...
  describe('GetAccountsChargesCurrency', function() {
    it('should create an instance of GetAccountsChargesCurrency', function() {
      // uncomment below and update the code to test GetAccountsChargesCurrency
      //var instane = new ApacheFineract.GetAccountsChargesCurrency();
      //expect(instance).to.be.a(ApacheFineract.GetAccountsChargesCurrency);
    });
