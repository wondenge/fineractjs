...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new ApacheFineract.GetSelfClientsClientIdTransactionsTransactionIdResponse();
  });
  ...
  describe('GetSelfClientsClientIdTransactionsTransactionIdResponse', function() {
    it('should create an instance of GetSelfClientsClientIdTransactionsTransactionIdResponse', function() {
      // uncomment below and update the code to test GetSelfClientsClientIdTransactionsTransactionIdResponse
      //var instane = new ApacheFineract.GetSelfClientsClientIdTransactionsTransactionIdResponse();
      //expect(instance).to.be.a(ApacheFineract.GetSelfClientsClientIdTransactionsTransactionIdResponse);
    });
