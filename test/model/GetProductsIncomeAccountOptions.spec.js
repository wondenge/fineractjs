...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new ApacheFineract.GetProductsIncomeAccountOptions();
  });
  ...
  describe('GetProductsIncomeAccountOptions', function() {
    it('should create an instance of GetProductsIncomeAccountOptions', function() {
      // uncomment below and update the code to test GetProductsIncomeAccountOptions
      //var instane = new ApacheFineract.GetProductsIncomeAccountOptions();
      //expect(instance).to.be.a(ApacheFineract.GetProductsIncomeAccountOptions);
    });
