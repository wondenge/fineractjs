...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new ApacheFineract.GetSelfSavingsTransactionCurrency();
  });
  ...
  describe('GetSelfSavingsTransactionCurrency', function() {
    it('should create an instance of GetSelfSavingsTransactionCurrency', function() {
      // uncomment below and update the code to test GetSelfSavingsTransactionCurrency
      //var instane = new ApacheFineract.GetSelfSavingsTransactionCurrency();
      //expect(instance).to.be.a(ApacheFineract.GetSelfSavingsTransactionCurrency);
    });
