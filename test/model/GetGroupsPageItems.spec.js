...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new ApacheFineract.GetGroupsPageItems();
  });
  ...
  describe('GetGroupsPageItems', function() {
    it('should create an instance of GetGroupsPageItems', function() {
      // uncomment below and update the code to test GetGroupsPageItems
      //var instane = new ApacheFineract.GetGroupsPageItems();
      //expect(instance).to.be.a(ApacheFineract.GetGroupsPageItems);
    });
