...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new ApacheFineract.GetSelfLoansLoanIdChargesResponse();
  });
  ...
  describe('GetSelfLoansLoanIdChargesResponse', function() {
    it('should create an instance of GetSelfLoansLoanIdChargesResponse', function() {
      // uncomment below and update the code to test GetSelfLoansLoanIdChargesResponse
      //var instane = new ApacheFineract.GetSelfLoansLoanIdChargesResponse();
      //expect(instance).to.be.a(ApacheFineract.GetSelfLoansLoanIdChargesResponse);
    });
