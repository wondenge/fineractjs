...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new ApacheFineract.GetSelfSavingsCurrency();
  });
  ...
  describe('GetSelfSavingsCurrency', function() {
    it('should create an instance of GetSelfSavingsCurrency', function() {
      // uncomment below and update the code to test GetSelfSavingsCurrency
      //var instane = new ApacheFineract.GetSelfSavingsCurrency();
      //expect(instance).to.be.a(ApacheFineract.GetSelfSavingsCurrency);
    });
