...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new ApacheFineract.PostAuthenticationResponse();
  });
  ...
  describe('PostAuthenticationResponse', function() {
    it('should create an instance of PostAuthenticationResponse', function() {
      // uncomment below and update the code to test PostAuthenticationResponse
      //var instane = new ApacheFineract.PostAuthenticationResponse();
      //expect(instance).to.be.a(ApacheFineract.PostAuthenticationResponse);
    });
