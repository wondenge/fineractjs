...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new ApacheFineract.GetLoansLoanIdResponse();
  });
  ...
  describe('GetLoansLoanIdResponse', function() {
    it('should create an instance of GetLoansLoanIdResponse', function() {
      // uncomment below and update the code to test GetLoansLoanIdResponse
      //var instane = new ApacheFineract.GetLoansLoanIdResponse();
      //expect(instance).to.be.a(ApacheFineract.GetLoansLoanIdResponse);
    });
