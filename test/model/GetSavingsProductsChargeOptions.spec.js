...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new ApacheFineract.GetSavingsProductsChargeOptions();
  });
  ...
  describe('GetSavingsProductsChargeOptions', function() {
    it('should create an instance of GetSavingsProductsChargeOptions', function() {
      // uncomment below and update the code to test GetSavingsProductsChargeOptions
      //var instane = new ApacheFineract.GetSavingsProductsChargeOptions();
      //expect(instance).to.be.a(ApacheFineract.GetSavingsProductsChargeOptions);
    });
