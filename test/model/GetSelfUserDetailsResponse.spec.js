...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new ApacheFineract.GetSelfUserDetailsResponse();
  });
  ...
  describe('GetSelfUserDetailsResponse', function() {
    it('should create an instance of GetSelfUserDetailsResponse', function() {
      // uncomment below and update the code to test GetSelfUserDetailsResponse
      //var instane = new ApacheFineract.GetSelfUserDetailsResponse();
      //expect(instance).to.be.a(ApacheFineract.GetSelfUserDetailsResponse);
    });
