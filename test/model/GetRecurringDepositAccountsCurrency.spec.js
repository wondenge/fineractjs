...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new ApacheFineract.GetRecurringDepositAccountsCurrency();
  });
  ...
  describe('GetRecurringDepositAccountsCurrency', function() {
    it('should create an instance of GetRecurringDepositAccountsCurrency', function() {
      // uncomment below and update the code to test GetRecurringDepositAccountsCurrency
      //var instane = new ApacheFineract.GetRecurringDepositAccountsCurrency();
      //expect(instance).to.be.a(ApacheFineract.GetRecurringDepositAccountsCurrency);
    });
