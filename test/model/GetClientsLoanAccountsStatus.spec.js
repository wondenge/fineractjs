...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new ApacheFineract.GetClientsLoanAccountsStatus();
  });
  ...
  describe('GetClientsLoanAccountsStatus', function() {
    it('should create an instance of GetClientsLoanAccountsStatus', function() {
      // uncomment below and update the code to test GetClientsLoanAccountsStatus
      //var instane = new ApacheFineract.GetClientsLoanAccountsStatus();
      //expect(instance).to.be.a(ApacheFineract.GetClientsLoanAccountsStatus);
    });
