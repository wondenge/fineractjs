...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new ApacheFineract.PutClientsClientIdResponse();
  });
  ...
  describe('PutClientsClientIdResponse', function() {
    it('should create an instance of PutClientsClientIdResponse', function() {
      // uncomment below and update the code to test PutClientsClientIdResponse
      //var instane = new ApacheFineract.PutClientsClientIdResponse();
      //expect(instance).to.be.a(ApacheFineract.PutClientsClientIdResponse);
    });
