...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new ApacheFineract.GetSelfClientsPageItems();
  });
  ...
  describe('GetSelfClientsPageItems', function() {
    it('should create an instance of GetSelfClientsPageItems', function() {
      // uncomment below and update the code to test GetSelfClientsPageItems
      //var instane = new ApacheFineract.GetSelfClientsPageItems();
      //expect(instance).to.be.a(ApacheFineract.GetSelfClientsPageItems);
    });
