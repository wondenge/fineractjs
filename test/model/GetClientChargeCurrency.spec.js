...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new ApacheFineract.GetClientChargeCurrency();
  });
  ...
  describe('GetClientChargeCurrency', function() {
    it('should create an instance of GetClientChargeCurrency', function() {
      // uncomment below and update the code to test GetClientChargeCurrency
      //var instane = new ApacheFineract.GetClientChargeCurrency();
      //expect(instance).to.be.a(ApacheFineract.GetClientChargeCurrency);
    });
