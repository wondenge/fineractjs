...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new ApacheFineract.GetCollateralCurrencyResponse();
  });
  ...
  describe('GetCollateralCurrencyResponse', function() {
    it('should create an instance of GetCollateralCurrencyResponse', function() {
      // uncomment below and update the code to test GetCollateralCurrencyResponse
      //var instane = new ApacheFineract.GetCollateralCurrencyResponse();
      //expect(instance).to.be.a(ApacheFineract.GetCollateralCurrencyResponse);
    });
