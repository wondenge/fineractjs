...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new ApacheFineract.PostBodyRequestSwagger();
  });
  ...
  describe('PostBodyRequestSwagger', function() {
    it('should create an instance of PostBodyRequestSwagger', function() {
      // uncomment below and update the code to test PostBodyRequestSwagger
      //var instane = new ApacheFineract.PostBodyRequestSwagger();
      //expect(instance).to.be.a(ApacheFineract.PostBodyRequestSwagger);
    });
