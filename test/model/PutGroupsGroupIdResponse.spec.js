...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new ApacheFineract.PutGroupsGroupIdResponse();
  });
  ...
  describe('PutGroupsGroupIdResponse', function() {
    it('should create an instance of PutGroupsGroupIdResponse', function() {
      // uncomment below and update the code to test PutGroupsGroupIdResponse
      //var instane = new ApacheFineract.PutGroupsGroupIdResponse();
      //expect(instance).to.be.a(ApacheFineract.PutGroupsGroupIdResponse);
    });
