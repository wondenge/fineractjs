...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new ApacheFineract.GetSelfLoansLoanIdTransactionsType();
  });
  ...
  describe('GetSelfLoansLoanIdTransactionsType', function() {
    it('should create an instance of GetSelfLoansLoanIdTransactionsType', function() {
      // uncomment below and update the code to test GetSelfLoansLoanIdTransactionsType
      //var instane = new ApacheFineract.GetSelfLoansLoanIdTransactionsType();
      //expect(instance).to.be.a(ApacheFineract.GetSelfLoansLoanIdTransactionsType);
    });
