...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new ApacheFineract.GetFixedDepositAccountsAccountChartCurrency();
  });
  ...
  describe('GetFixedDepositAccountsAccountChartCurrency', function() {
    it('should create an instance of GetFixedDepositAccountsAccountChartCurrency', function() {
      // uncomment below and update the code to test GetFixedDepositAccountsAccountChartCurrency
      //var instane = new ApacheFineract.GetFixedDepositAccountsAccountChartCurrency();
      //expect(instance).to.be.a(ApacheFineract.GetFixedDepositAccountsAccountChartCurrency);
    });
