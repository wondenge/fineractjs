...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new ApacheFineract.GetLoanProductsAssetAccountOptions();
  });
  ...
  describe('GetLoanProductsAssetAccountOptions', function() {
    it('should create an instance of GetLoanProductsAssetAccountOptions', function() {
      // uncomment below and update the code to test GetLoanProductsAssetAccountOptions
      //var instane = new ApacheFineract.GetLoanProductsAssetAccountOptions();
      //expect(instance).to.be.a(ApacheFineract.GetLoanProductsAssetAccountOptions);
    });
