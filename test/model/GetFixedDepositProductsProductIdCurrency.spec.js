...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new ApacheFineract.GetFixedDepositProductsProductIdCurrency();
  });
  ...
  describe('GetFixedDepositProductsProductIdCurrency', function() {
    it('should create an instance of GetFixedDepositProductsProductIdCurrency', function() {
      // uncomment below and update the code to test GetFixedDepositProductsProductIdCurrency
      //var instane = new ApacheFineract.GetFixedDepositProductsProductIdCurrency();
      //expect(instance).to.be.a(ApacheFineract.GetFixedDepositProductsProductIdCurrency);
    });
