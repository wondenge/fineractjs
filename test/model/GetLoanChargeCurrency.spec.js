...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new ApacheFineract.GetLoanChargeCurrency();
  });
  ...
  describe('GetLoanChargeCurrency', function() {
    it('should create an instance of GetLoanChargeCurrency', function() {
      // uncomment below and update the code to test GetLoanChargeCurrency
      //var instane = new ApacheFineract.GetLoanChargeCurrency();
      //expect(instance).to.be.a(ApacheFineract.GetLoanChargeCurrency);
    });
