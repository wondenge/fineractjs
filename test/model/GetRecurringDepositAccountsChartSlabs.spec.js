...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new ApacheFineract.GetRecurringDepositAccountsChartSlabs();
  });
  ...
  describe('GetRecurringDepositAccountsChartSlabs', function() {
    it('should create an instance of GetRecurringDepositAccountsChartSlabs', function() {
      // uncomment below and update the code to test GetRecurringDepositAccountsChartSlabs
      //var instane = new ApacheFineract.GetRecurringDepositAccountsChartSlabs();
      //expect(instance).to.be.a(ApacheFineract.GetRecurringDepositAccountsChartSlabs);
    });
