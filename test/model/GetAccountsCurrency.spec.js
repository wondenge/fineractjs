...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new ApacheFineract.GetAccountsCurrency();
  });
  ...
  describe('GetAccountsCurrency', function() {
    it('should create an instance of GetAccountsCurrency', function() {
      // uncomment below and update the code to test GetAccountsCurrency
      //var instane = new ApacheFineract.GetAccountsCurrency();
      //expect(instance).to.be.a(ApacheFineract.GetAccountsCurrency);
    });
