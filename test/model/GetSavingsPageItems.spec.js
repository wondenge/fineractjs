...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new ApacheFineract.GetSavingsPageItems();
  });
  ...
  describe('GetSavingsPageItems', function() {
    it('should create an instance of GetSavingsPageItems', function() {
      // uncomment below and update the code to test GetSavingsPageItems
      //var instane = new ApacheFineract.GetSavingsPageItems();
      //expect(instance).to.be.a(ApacheFineract.GetSavingsPageItems);
    });
