...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new ApacheFineract.PostLoansLoanIdResponse();
  });
  ...
  describe('PostLoansLoanIdResponse', function() {
    it('should create an instance of PostLoansLoanIdResponse', function() {
      // uncomment below and update the code to test PostLoansLoanIdResponse
      //var instane = new ApacheFineract.PostLoansLoanIdResponse();
      //expect(instance).to.be.a(ApacheFineract.PostLoansLoanIdResponse);
    });
