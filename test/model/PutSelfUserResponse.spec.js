...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new ApacheFineract.PutSelfUserResponse();
  });
  ...
  describe('PutSelfUserResponse', function() {
    it('should create an instance of PutSelfUserResponse', function() {
      // uncomment below and update the code to test PutSelfUserResponse
      //var instane = new ApacheFineract.PutSelfUserResponse();
      //expect(instance).to.be.a(ApacheFineract.PutSelfUserResponse);
    });
