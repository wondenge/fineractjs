...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new ApacheFineract.ContentDisposition();
  });
  ...
  describe('ContentDisposition', function() {
    it('should create an instance of ContentDisposition', function() {
      ...
      //var instane = new ApacheFineract.ContentDisposition();
      //expect(instance).to.be.a(ApacheFineract.ContentDisposition);
    });
