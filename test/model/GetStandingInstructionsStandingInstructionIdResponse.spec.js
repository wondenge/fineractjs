...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new ApacheFineract.GetStandingInstructionsStandingInstructionIdResponse();
  });
  ...
  describe('GetStandingInstructionsStandingInstructionIdResponse', function() {
    it('should create an instance of GetStandingInstructionsStandingInstructionIdResponse', function() {
      // uncomment below and update the code to test GetStandingInstructionsStandingInstructionIdResponse
      //var instane = new ApacheFineract.GetStandingInstructionsStandingInstructionIdResponse();
      //expect(instance).to.be.a(ApacheFineract.GetStandingInstructionsStandingInstructionIdResponse);
    });
