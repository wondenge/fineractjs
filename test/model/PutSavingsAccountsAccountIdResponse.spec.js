...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new ApacheFineract.PutSavingsAccountsAccountIdResponse();
  });
  ...
  describe('PutSavingsAccountsAccountIdResponse', function() {
    it('should create an instance of PutSavingsAccountsAccountIdResponse', function() {
      // uncomment below and update the code to test PutSavingsAccountsAccountIdResponse
      //var instane = new ApacheFineract.PutSavingsAccountsAccountIdResponse();
      //expect(instance).to.be.a(ApacheFineract.PutSavingsAccountsAccountIdResponse);
    });
