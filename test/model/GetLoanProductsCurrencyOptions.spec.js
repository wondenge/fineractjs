...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new ApacheFineract.GetLoanProductsCurrencyOptions();
  });
  ...
  describe('GetLoanProductsCurrencyOptions', function() {
    it('should create an instance of GetLoanProductsCurrencyOptions', function() {
      // uncomment below and update the code to test GetLoanProductsCurrencyOptions
      //var instane = new ApacheFineract.GetLoanProductsCurrencyOptions();
      //expect(instance).to.be.a(ApacheFineract.GetLoanProductsCurrencyOptions);
    });
