...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new ApacheFineract.GetRecurringDepositAccountsAccountIdResponse();
  });
  ...
  describe('GetRecurringDepositAccountsAccountIdResponse', function() {
    it('should create an instance of GetRecurringDepositAccountsAccountIdResponse', function() {
      // uncomment below and update the code to test GetRecurringDepositAccountsAccountIdResponse
      //var instane = new ApacheFineract.GetRecurringDepositAccountsAccountIdResponse();
      //expect(instance).to.be.a(ApacheFineract.GetRecurringDepositAccountsAccountIdResponse);
    });
    ...
    it('should have the property expectedFirstDepositOnDate (base name: "expectedFirstDepositOnDate")', function() {
      // uncomment below and update the code to test the property expectedFirstDepositOnDate
      //var instane = new ApacheFineract.GetRecurringDepositAccountsAccountIdResponse();
      //expect(instance).to.be();
    });
    ...
    it('should have the property accountChart (base name: "accountChart")', function() {
      // uncomment below and update the code to test the property accountChart
      //var instane = new ApacheFineract.GetRecurringDepositAccountsAccountIdResponse();
      //expect(instance).to.be();
    });
