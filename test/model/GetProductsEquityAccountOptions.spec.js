...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new ApacheFineract.GetProductsEquityAccountOptions();
  });
  ...
  describe('GetProductsEquityAccountOptions', function() {
    it('should create an instance of GetProductsEquityAccountOptions', function() {
      // uncomment below and update the code to test GetProductsEquityAccountOptions
      //var instane = new ApacheFineract.GetProductsEquityAccountOptions();
      //expect(instance).to.be.a(ApacheFineract.GetProductsEquityAccountOptions);
    });
