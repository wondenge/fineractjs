...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new ApacheFineract.PostSavingsAccountsResponse();
  });
  ...
  describe('PostSavingsAccountsResponse', function() {
    it('should create an instance of PostSavingsAccountsResponse', function() {
      // uncomment below and update the code to test PostSavingsAccountsResponse
      //var instane = new ApacheFineract.PostSavingsAccountsResponse();
      //expect(instance).to.be.a(ApacheFineract.PostSavingsAccountsResponse);
    });
