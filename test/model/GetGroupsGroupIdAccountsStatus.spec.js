...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new ApacheFineract.GetGroupsGroupIdAccountsStatus();
  });
  ...
  describe('GetGroupsGroupIdAccountsStatus', function() {
    it('should create an instance of GetGroupsGroupIdAccountsStatus', function() {
      // uncomment below and update the code to test GetGroupsGroupIdAccountsStatus
      //var instane = new ApacheFineract.GetGroupsGroupIdAccountsStatus();
      //expect(instance).to.be.a(ApacheFineract.GetGroupsGroupIdAccountsStatus);
    });
