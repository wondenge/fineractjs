...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new ApacheFineract.GetRecurringDepositProductsProductIdCurrency();
  });
  ...
  describe('GetRecurringDepositProductsProductIdCurrency', function() {
    it('should create an instance of GetRecurringDepositProductsProductIdCurrency', function() {
      // uncomment below and update the code to test GetRecurringDepositProductsProductIdCurrency
      //var instane = new ApacheFineract.GetRecurringDepositProductsProductIdCurrency();
      //expect(instance).to.be.a(ApacheFineract.GetRecurringDepositProductsProductIdCurrency);
    });
