...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new ApacheFineract.PostProductsMarketPricePeriods();
  });
  ...
  describe('PostProductsMarketPricePeriods', function() {
    it('should create an instance of PostProductsMarketPricePeriods', function() {
      // uncomment below and update the code to test PostProductsMarketPricePeriods
      //var instane = new ApacheFineract.PostProductsMarketPricePeriods();
      //expect(instance).to.be.a(ApacheFineract.PostProductsMarketPricePeriods);
    });
