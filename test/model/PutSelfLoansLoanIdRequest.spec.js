...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new ApacheFineract.PutSelfLoansLoanIdRequest();
  });
  ...
  describe('PutSelfLoansLoanIdRequest', function() {
    it('should create an instance of PutSelfLoansLoanIdRequest', function() {
      // uncomment below and update the code to test PutSelfLoansLoanIdRequest
      //var instane = new ApacheFineract.PutSelfLoansLoanIdRequest();
      //expect(instance).to.be.a(ApacheFineract.PutSelfLoansLoanIdRequest);
    });
