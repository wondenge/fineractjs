...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new ApacheFineract.GetSavingsProductsAccountingMappings();
  });
  ...
  describe('GetSavingsProductsAccountingMappings', function() {
    it('should create an instance of GetSavingsProductsAccountingMappings', function() {
      // uncomment below and update the code to test GetSavingsProductsAccountingMappings
      //var instane = new ApacheFineract.GetSavingsProductsAccountingMappings();
      //expect(instance).to.be.a(ApacheFineract.GetSavingsProductsAccountingMappings);
    });
