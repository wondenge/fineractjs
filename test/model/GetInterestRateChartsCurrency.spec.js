...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new ApacheFineract.GetInterestRateChartsCurrency();
  });
  ...
  describe('GetInterestRateChartsCurrency', function() {
    it('should create an instance of GetInterestRateChartsCurrency', function() {
      // uncomment below and update the code to test GetInterestRateChartsCurrency
      //var instane = new ApacheFineract.GetInterestRateChartsCurrency();
      //expect(instance).to.be.a(ApacheFineract.GetInterestRateChartsCurrency);
    });
