...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new ApacheFineract.GetGroupsGroupIdAccountsSavingStatus();
  });
  ...
  describe('GetGroupsGroupIdAccountsSavingStatus', function() {
    it('should create an instance of GetGroupsGroupIdAccountsSavingStatus', function() {
      // uncomment below and update the code to test GetGroupsGroupIdAccountsSavingStatus
      //var instane = new ApacheFineract.GetGroupsGroupIdAccountsSavingStatus();
      //expect(instance).to.be.a(ApacheFineract.GetGroupsGroupIdAccountsSavingStatus);
    });
