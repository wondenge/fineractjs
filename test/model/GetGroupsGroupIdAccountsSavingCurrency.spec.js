...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new ApacheFineract.GetGroupsGroupIdAccountsSavingCurrency();
  });
  ...
  describe('GetGroupsGroupIdAccountsSavingCurrency', function() {
    it('should create an instance of GetGroupsGroupIdAccountsSavingCurrency', function() {
      // uncomment below and update the code to test GetGroupsGroupIdAccountsSavingCurrency
      //var instane = new ApacheFineract.GetGroupsGroupIdAccountsSavingCurrency();
      //expect(instance).to.be.a(ApacheFineract.GetGroupsGroupIdAccountsSavingCurrency);
    });
