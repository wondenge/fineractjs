...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new ApacheFineract.GetSelfSavingsStatus();
  });
  ...
  describe('GetSelfSavingsStatus', function() {
    it('should create an instance of GetSelfSavingsStatus', function() {
      // uncomment below and update the code to test GetSelfSavingsStatus
      //var instane = new ApacheFineract.GetSelfSavingsStatus();
      //expect(instance).to.be.a(ApacheFineract.GetSelfSavingsStatus);
    });
