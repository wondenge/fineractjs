...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new ApacheFineract.PostLoansLoanIdChargesChargeIdResponse();
  });
  ...
  describe('PostLoansLoanIdChargesChargeIdResponse', function() {
    it('should create an instance of PostLoansLoanIdChargesChargeIdResponse', function() {
      // uncomment below and update the code to test PostLoansLoanIdChargesChargeIdResponse
      //var instane = new ApacheFineract.PostLoansLoanIdChargesChargeIdResponse();
      //expect(instance).to.be.a(ApacheFineract.PostLoansLoanIdChargesChargeIdResponse);
    });
