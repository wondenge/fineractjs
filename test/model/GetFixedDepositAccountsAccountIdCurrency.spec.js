...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new ApacheFineract.GetFixedDepositAccountsAccountIdCurrency();
  });
  ...
  describe('GetFixedDepositAccountsAccountIdCurrency', function() {
    it('should create an instance of GetFixedDepositAccountsAccountIdCurrency', function() {
      // uncomment below and update the code to test GetFixedDepositAccountsAccountIdCurrency
      //var instane = new ApacheFineract.GetFixedDepositAccountsAccountIdCurrency();
      //expect(instance).to.be.a(ApacheFineract.GetFixedDepositAccountsAccountIdCurrency);
    });
