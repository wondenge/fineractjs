...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new ApacheFineract.GetLoansLoanIdStatus();
  });
  ...
  describe('GetLoansLoanIdStatus', function() {
    it('should create an instance of GetLoansLoanIdStatus', function() {
      // uncomment below and update the code to test GetLoansLoanIdStatus
      //var instane = new ApacheFineract.GetLoansLoanIdStatus();
      //expect(instance).to.be.a(ApacheFineract.GetLoansLoanIdStatus);
    });
