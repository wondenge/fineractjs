...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new ApacheFineract.GetOfficesResponse();
  });
  ...
  describe('GetOfficesResponse', function() {
    it('should create an instance of GetOfficesResponse', function() {
      // uncomment below and update the code to test GetOfficesResponse
      //var instane = new ApacheFineract.GetOfficesResponse();
      //expect(instance).to.be.a(ApacheFineract.GetOfficesResponse);
    });
