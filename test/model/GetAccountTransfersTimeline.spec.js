...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new ApacheFineract.GetAccountTransfersTimeline();
  });
  ...
  describe('GetAccountTransfersTimeline', function() {
    it('should create an instance of GetAccountTransfersTimeline', function() {
      // uncomment below and update the code to test GetAccountTransfersTimeline
      //var instane = new ApacheFineract.GetAccountTransfersTimeline();
      //expect(instance).to.be.a(ApacheFineract.GetAccountTransfersTimeline);
    });
