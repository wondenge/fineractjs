...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new ApacheFineract.GetSavingsProductsAccountingMappingOptions();
  });
  ...
  describe('GetSavingsProductsAccountingMappingOptions', function() {
    it('should create an instance of GetSavingsProductsAccountingMappingOptions', function() {
      // uncomment below and update the code to test GetSavingsProductsAccountingMappingOptions
      //var instane = new ApacheFineract.GetSavingsProductsAccountingMappingOptions();
      //expect(instance).to.be.a(ApacheFineract.GetSavingsProductsAccountingMappingOptions);
    });
