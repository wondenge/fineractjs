...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new ApacheFineract.CommandProcessingResult();
  });
  ...
  describe('CommandProcessingResult', function() {
    it('should create an instance of CommandProcessingResult', function() {
      // uncomment below and update the code to test CommandProcessingResult
      //var instane = new ApacheFineract.CommandProcessingResult();
      //expect(instance).to.be.a(ApacheFineract.CommandProcessingResult);
    });
