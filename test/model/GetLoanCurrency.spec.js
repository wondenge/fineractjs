...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new ApacheFineract.GetLoanCurrency();
  });
  ...
  describe('GetLoanCurrency', function() {
    it('should create an instance of GetLoanCurrency', function() {
      // uncomment below and update the code to test GetLoanCurrency
      //var instane = new ApacheFineract.GetLoanCurrency();
      //expect(instance).to.be.a(ApacheFineract.GetLoanCurrency);
    });
