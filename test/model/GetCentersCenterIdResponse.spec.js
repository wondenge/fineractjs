...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new ApacheFineract.GetCentersCenterIdResponse();
  });
  ...
  describe('GetCentersCenterIdResponse', function() {
    it('should create an instance of GetCentersCenterIdResponse', function() {
      // uncomment below and update the code to test GetCentersCenterIdResponse
      //var instane = new ApacheFineract.GetCentersCenterIdResponse();
      //expect(instance).to.be.a(ApacheFineract.GetCentersCenterIdResponse);
    });
