...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new ApacheFineract.GetAccountTransfersPageItemsCurrency();
  });
  ...
  describe('GetAccountTransfersPageItemsCurrency', function() {
    it('should create an instance of GetAccountTransfersPageItemsCurrency', function() {
      // uncomment below and update the code to test GetAccountTransfersPageItemsCurrency
      //var instane = new ApacheFineract.GetAccountTransfersPageItemsCurrency();
      //expect(instance).to.be.a(ApacheFineract.GetAccountTransfersPageItemsCurrency);
    });
