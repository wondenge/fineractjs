...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new ApacheFineract.GetSelfClientsClientIdResponse();
  });
  ...
  describe('GetSelfClientsClientIdResponse', function() {
    it('should create an instance of GetSelfClientsClientIdResponse', function() {
      // uncomment below and update the code to test GetSelfClientsClientIdResponse
      //var instane = new ApacheFineract.GetSelfClientsClientIdResponse();
      //expect(instance).to.be.a(ApacheFineract.GetSelfClientsClientIdResponse);
    });
