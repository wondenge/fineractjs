...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new ApacheFineract.GetSelfClientsLoanAccountsStatus();
  });
  ...
  describe('GetSelfClientsLoanAccountsStatus', function() {
    it('should create an instance of GetSelfClientsLoanAccountsStatus', function() {
      // uncomment below and update the code to test GetSelfClientsLoanAccountsStatus
      //var instane = new ApacheFineract.GetSelfClientsLoanAccountsStatus();
      //expect(instance).to.be.a(ApacheFineract.GetSelfClientsLoanAccountsStatus);
    });
