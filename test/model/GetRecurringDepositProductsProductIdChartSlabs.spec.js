...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new ApacheFineract.GetRecurringDepositProductsProductIdChartSlabs();
  });
  ...
  describe('GetRecurringDepositProductsProductIdChartSlabs', function() {
    it('should create an instance of GetRecurringDepositProductsProductIdChartSlabs', function() {
      // uncomment below and update the code to test GetRecurringDepositProductsProductIdChartSlabs
      //var instane = new ApacheFineract.GetRecurringDepositProductsProductIdChartSlabs();
      //expect(instance).to.be.a(ApacheFineract.GetRecurringDepositProductsProductIdChartSlabs);
    });
