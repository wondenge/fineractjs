...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new ApacheFineract.PostTellersTellerIdCashiersCashierIdAllocateRequest();
  });
  ...
  describe('PostTellersTellerIdCashiersCashierIdAllocateRequest', function() {
    it('should create an instance of PostTellersTellerIdCashiersCashierIdAllocateRequest', function() {
      // uncomment below and update the code to test PostTellersTellerIdCashiersCashierIdAllocateRequest
      //var instane = new ApacheFineract.PostTellersTellerIdCashiersCashierIdAllocateRequest();
      //expect(instance).to.be.a(ApacheFineract.PostTellersTellerIdCashiersCashierIdAllocateRequest);
    });
