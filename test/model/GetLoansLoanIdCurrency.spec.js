...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new ApacheFineract.GetLoansLoanIdCurrency();
  });
  ...
  describe('GetLoansLoanIdCurrency', function() {
    it('should create an instance of GetLoansLoanIdCurrency', function() {
      // uncomment below and update the code to test GetLoansLoanIdCurrency
      //var instane = new ApacheFineract.GetLoansLoanIdCurrency();
      //expect(instance).to.be.a(ApacheFineract.GetLoansLoanIdCurrency);
    });
