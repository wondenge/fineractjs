...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new ApacheFineract.GetSavingsProductsLiabilityAccountOptions();
  });
  ...
  describe('GetSavingsProductsLiabilityAccountOptions', function() {
    it('should create an instance of GetSavingsProductsLiabilityAccountOptions', function() {
      // uncomment below and update the code to test GetSavingsProductsLiabilityAccountOptions
      //var instane = new ApacheFineract.GetSavingsProductsLiabilityAccountOptions();
      //expect(instance).to.be.a(ApacheFineract.GetSavingsProductsLiabilityAccountOptions);
    });
