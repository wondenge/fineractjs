...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new ApacheFineract.PostSelfLoansLoanIdResponse();
  });
  ...
  describe('PostSelfLoansLoanIdResponse', function() {
    it('should create an instance of PostSelfLoansLoanIdResponse', function() {
      // uncomment below and update the code to test PostSelfLoansLoanIdResponse
      //var instane = new ApacheFineract.PostSelfLoansLoanIdResponse();
      //expect(instance).to.be.a(ApacheFineract.PostSelfLoansLoanIdResponse);
    });
