...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new ApacheFineract.GetAccountsTypeStatus();
  });
  ...
  describe('GetAccountsTypeStatus', function() {
    it('should create an instance of GetAccountsTypeStatus', function() {
      // uncomment below and update the code to test GetAccountsTypeStatus
      //var instane = new ApacheFineract.GetAccountsTypeStatus();
      //expect(instance).to.be.a(ApacheFineract.GetAccountsTypeStatus);
    });
