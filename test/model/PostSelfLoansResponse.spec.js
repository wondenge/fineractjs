...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new ApacheFineract.PostSelfLoansResponse();
  });
  ...
  describe('PostSelfLoansResponse', function() {
    it('should create an instance of PostSelfLoansResponse', function() {
      // uncomment below and update the code to test PostSelfLoansResponse
      //var instane = new ApacheFineract.PostSelfLoansResponse();
      //expect(instance).to.be.a(ApacheFineract.PostSelfLoansResponse);
    });
