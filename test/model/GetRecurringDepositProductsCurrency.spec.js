...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new ApacheFineract.GetRecurringDepositProductsCurrency();
  });
  ...
  describe('GetRecurringDepositProductsCurrency', function() {
    it('should create an instance of GetRecurringDepositProductsCurrency', function() {
      // uncomment below and update the code to test GetRecurringDepositProductsCurrency
      //var instane = new ApacheFineract.GetRecurringDepositProductsCurrency();
      //expect(instance).to.be.a(ApacheFineract.GetRecurringDepositProductsCurrency);
    });
