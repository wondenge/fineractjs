...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new ApacheFineract.GetClientTransactionsCurrency();
  });
  ...
  describe('GetClientTransactionsCurrency', function() {
    it('should create an instance of GetClientTransactionsCurrency', function() {
      // uncomment below and update the code to test GetClientTransactionsCurrency
      //var instane = new ApacheFineract.GetClientTransactionsCurrency();
      //expect(instance).to.be.a(ApacheFineract.GetClientTransactionsCurrency);
    });
