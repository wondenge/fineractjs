...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new ApacheFineract.PutFixedDepositAccountsAccountIdResponse();
  });
  ...
  describe('PutFixedDepositAccountsAccountIdResponse', function() {
    it('should create an instance of PutFixedDepositAccountsAccountIdResponse', function() {
      // uncomment below and update the code to test PutFixedDepositAccountsAccountIdResponse
      //var instane = new ApacheFineract.PutFixedDepositAccountsAccountIdResponse();
      //expect(instance).to.be.a(ApacheFineract.PutFixedDepositAccountsAccountIdResponse);
    });
