...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new ApacheFineract.GetSelfClientsClientIdChargesChargeIdResponse();
  });
  ...
  describe('GetSelfClientsClientIdChargesChargeIdResponse', function() {
    it('should create an instance of GetSelfClientsClientIdChargesChargeIdResponse', function() {
      // uncomment below and update the code to test GetSelfClientsClientIdChargesChargeIdResponse
      //var instane = new ApacheFineract.GetSelfClientsClientIdChargesChargeIdResponse();
      //expect(instance).to.be.a(ApacheFineract.GetSelfClientsClientIdChargesChargeIdResponse);
    });
