...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new ApacheFineract.GetCentersPageItems();
  });
  ...
  describe('GetCentersPageItems', function() {
    it('should create an instance of GetCentersPageItems', function() {
      // uncomment below and update the code to test GetCentersPageItems
      //var instane = new ApacheFineract.GetCentersPageItems();
      //expect(instance).to.be.a(ApacheFineract.GetCentersPageItems);
    });
