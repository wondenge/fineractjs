...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new ApacheFineract.GetSelfLoansTemplateResponse();
  });
  ...
  describe('GetSelfLoansTemplateResponse', function() {
    it('should create an instance of GetSelfLoansTemplateResponse', function() {
      // uncomment below and update the code to test GetSelfLoansTemplateResponse
      //var instane = new ApacheFineract.GetSelfLoansTemplateResponse();
      //expect(instance).to.be.a(ApacheFineract.GetSelfLoansTemplateResponse);
    });
