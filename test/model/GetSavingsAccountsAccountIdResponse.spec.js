...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new ApacheFineract.GetSavingsAccountsAccountIdResponse();
  });
  ...
  describe('GetSavingsAccountsAccountIdResponse', function() {
    it('should create an instance of GetSavingsAccountsAccountIdResponse', function() {
      // uncomment below and update the code to test GetSavingsAccountsAccountIdResponse
      //var instane = new ApacheFineract.GetSavingsAccountsAccountIdResponse();
      //expect(instance).to.be.a(ApacheFineract.GetSavingsAccountsAccountIdResponse);
    });
