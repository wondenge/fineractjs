...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new ApacheFineract.GetAccountsStatus();
  });
  ...
  describe('GetAccountsStatus', function() {
    it('should create an instance of GetAccountsStatus', function() {
      // uncomment below and update the code to test GetAccountsStatus
      //var instane = new ApacheFineract.GetAccountsStatus();
      //expect(instance).to.be.a(ApacheFineract.GetAccountsStatus);
    });
