...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new ApacheFineract.GetFixedDepositAccountsStatus();
  });
  ...
  describe('GetFixedDepositAccountsStatus', function() {
    it('should create an instance of GetFixedDepositAccountsStatus', function() {
      // uncomment below and update the code to test GetFixedDepositAccountsStatus
      //var instane = new ApacheFineract.GetFixedDepositAccountsStatus();
      //expect(instance).to.be.a(ApacheFineract.GetFixedDepositAccountsStatus);
    });
