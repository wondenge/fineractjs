...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new ApacheFineract.GetTellersTellerIdCashiersResponse();
  });
  ...
  describe('GetTellersTellerIdCashiersResponse', function() {
    it('should create an instance of GetTellersTellerIdCashiersResponse', function() {
      // uncomment below and update the code to test GetTellersTellerIdCashiersResponse
      //var instane = new ApacheFineract.GetTellersTellerIdCashiersResponse();
      //expect(instance).to.be.a(ApacheFineract.GetTellersTellerIdCashiersResponse);
    });
