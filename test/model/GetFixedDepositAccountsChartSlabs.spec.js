...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new ApacheFineract.GetFixedDepositAccountsChartSlabs();
  });
  ...
  describe('GetFixedDepositAccountsChartSlabs', function() {
    it('should create an instance of GetFixedDepositAccountsChartSlabs', function() {
      // uncomment below and update the code to test GetFixedDepositAccountsChartSlabs
      //var instane = new ApacheFineract.GetFixedDepositAccountsChartSlabs();
      //expect(instance).to.be.a(ApacheFineract.GetFixedDepositAccountsChartSlabs);
    });
