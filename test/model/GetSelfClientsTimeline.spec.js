...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new ApacheFineract.GetSelfClientsTimeline();
  });
  ...
  describe('GetSelfClientsTimeline', function() {
    it('should create an instance of GetSelfClientsTimeline', function() {
      // uncomment below and update the code to test GetSelfClientsTimeline
      //var instane = new ApacheFineract.GetSelfClientsTimeline();
      //expect(instance).to.be.a(ApacheFineract.GetSelfClientsTimeline);
    });
