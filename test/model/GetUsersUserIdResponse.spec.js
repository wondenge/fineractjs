...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new ApacheFineract.GetUsersUserIdResponse();
  });
  ...
  describe('GetUsersUserIdResponse', function() {
    it('should create an instance of GetUsersUserIdResponse', function() {
      // uncomment below and update the code to test GetUsersUserIdResponse
      //var instane = new ApacheFineract.GetUsersUserIdResponse();
      //expect(instance).to.be.a(ApacheFineract.GetUsersUserIdResponse);
    });
