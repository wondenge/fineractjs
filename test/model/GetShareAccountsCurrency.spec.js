...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new ApacheFineract.GetShareAccountsCurrency();
  });
  ...
  describe('GetShareAccountsCurrency', function() {
    it('should create an instance of GetShareAccountsCurrency', function() {
      // uncomment below and update the code to test GetShareAccountsCurrency
      //var instane = new ApacheFineract.GetShareAccountsCurrency();
      //expect(instance).to.be.a(ApacheFineract.GetShareAccountsCurrency);
    });
