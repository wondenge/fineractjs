...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new ApacheFineract.GetLoansCurrency();
  });
  ...
  describe('GetLoansCurrency', function() {
    it('should create an instance of GetLoansCurrency', function() {
      // uncomment below and update the code to test GetLoansCurrency
      //var instane = new ApacheFineract.GetLoansCurrency();
      //expect(instance).to.be.a(ApacheFineract.GetLoansCurrency);
    });
