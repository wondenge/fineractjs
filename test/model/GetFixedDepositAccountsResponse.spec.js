...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new ApacheFineract.GetFixedDepositAccountsResponse();
  });
  ...
  describe('GetFixedDepositAccountsResponse', function() {
    it('should create an instance of GetFixedDepositAccountsResponse', function() {
      // uncomment below and update the code to test GetFixedDepositAccountsResponse
      //var instane = new ApacheFineract.GetFixedDepositAccountsResponse();
      //expect(instance).to.be.a(ApacheFineract.GetFixedDepositAccountsResponse);
    });
