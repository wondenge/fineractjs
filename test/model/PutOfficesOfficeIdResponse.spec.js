...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new ApacheFineract.PutOfficesOfficeIdResponse();
  });
  ...
  describe('PutOfficesOfficeIdResponse', function() {
    it('should create an instance of PutOfficesOfficeIdResponse', function() {
      // uncomment below and update the code to test PutOfficesOfficeIdResponse
      //var instane = new ApacheFineract.PutOfficesOfficeIdResponse();
      //expect(instance).to.be.a(ApacheFineract.PutOfficesOfficeIdResponse);
    });
