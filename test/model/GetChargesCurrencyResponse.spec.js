...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new ApacheFineract.GetChargesCurrencyResponse();
  });
  ...
  describe('GetChargesCurrencyResponse', function() {
    it('should create an instance of GetChargesCurrencyResponse', function() {
      // uncomment below and update the code to test GetChargesCurrencyResponse
      //var instane = new ApacheFineract.GetChargesCurrencyResponse();
      //expect(instance).to.be.a(ApacheFineract.GetChargesCurrencyResponse);
    });
