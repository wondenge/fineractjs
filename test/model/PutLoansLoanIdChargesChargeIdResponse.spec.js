...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new ApacheFineract.PutLoansLoanIdChargesChargeIdResponse();
  });
  ...
  describe('PutLoansLoanIdChargesChargeIdResponse', function() {
    it('should create an instance of PutLoansLoanIdChargesChargeIdResponse', function() {
      // uncomment below and update the code to test PutLoansLoanIdChargesChargeIdResponse
      //var instane = new ApacheFineract.PutLoansLoanIdChargesChargeIdResponse();
      //expect(instance).to.be.a(ApacheFineract.PutLoansLoanIdChargesChargeIdResponse);
    });
