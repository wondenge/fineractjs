...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new ApacheFineract.InteropIdentifiersResponseData();
  });
  ...
  describe('InteropIdentifiersResponseData', function() {
    it('should create an instance of InteropIdentifiersResponseData', function() {
      // uncomment below and update the code to test InteropIdentifiersResponseData
      //var instane = new ApacheFineract.InteropIdentifiersResponseData();
      //expect(instance).to.be.a(ApacheFineract.InteropIdentifiersResponseData);
    });
