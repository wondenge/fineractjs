...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new ApacheFineract.GetCentersCenterIdCurrency();
  });
  ...
  describe('GetCentersCenterIdCurrency', function() {
    it('should create an instance of GetCentersCenterIdCurrency', function() {
      // uncomment below and update the code to test GetCentersCenterIdCurrency
      //var instane = new ApacheFineract.GetCentersCenterIdCurrency();
      //expect(instance).to.be.a(ApacheFineract.GetCentersCenterIdCurrency);
    });
