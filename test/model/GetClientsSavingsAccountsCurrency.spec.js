...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new ApacheFineract.GetClientsSavingsAccountsCurrency();
  });
  ...
  describe('GetClientsSavingsAccountsCurrency', function() {
    it('should create an instance of GetClientsSavingsAccountsCurrency', function() {
      // uncomment below and update the code to test GetClientsSavingsAccountsCurrency
      //var instane = new ApacheFineract.GetClientsSavingsAccountsCurrency();
      //expect(instance).to.be.a(ApacheFineract.GetClientsSavingsAccountsCurrency);
    });
