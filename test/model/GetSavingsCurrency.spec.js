...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new ApacheFineract.GetSavingsCurrency();
  });
  ...
  describe('GetSavingsCurrency', function() {
    it('should create an instance of GetSavingsCurrency', function() {
      // uncomment below and update the code to test GetSavingsCurrency
      //var instane = new ApacheFineract.GetSavingsCurrency();
      //expect(instance).to.be.a(ApacheFineract.GetSavingsCurrency);
    });
