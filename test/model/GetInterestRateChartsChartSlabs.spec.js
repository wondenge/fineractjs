...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new ApacheFineract.GetInterestRateChartsChartSlabs();
  });
  ...
  describe('GetInterestRateChartsChartSlabs', function() {
    it('should create an instance of GetInterestRateChartsChartSlabs', function() {
      // uncomment below and update the code to test GetInterestRateChartsChartSlabs
      //var instane = new ApacheFineract.GetInterestRateChartsChartSlabs();
      //expect(instance).to.be.a(ApacheFineract.GetInterestRateChartsChartSlabs);
    });
