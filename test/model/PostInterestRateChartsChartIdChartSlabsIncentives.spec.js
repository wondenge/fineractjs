...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new ApacheFineract.PostInterestRateChartsChartIdChartSlabsIncentives();
  });
  ...
  describe('PostInterestRateChartsChartIdChartSlabsIncentives', function() {
    it('should create an instance of PostInterestRateChartsChartIdChartSlabsIncentives', function() {
      // uncomment below and update the code to test PostInterestRateChartsChartIdChartSlabsIncentives
      //var instane = new ApacheFineract.PostInterestRateChartsChartIdChartSlabsIncentives();
      //expect(instance).to.be.a(ApacheFineract.PostInterestRateChartsChartIdChartSlabsIncentives);
    });
