...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new ApacheFineract.GetRecurringDepositProductsProductIdResponse();
  });
  ...
  describe('GetRecurringDepositProductsProductIdResponse', function() {
    it('should create an instance of GetRecurringDepositProductsProductIdResponse', function() {
      // uncomment below and update the code to test GetRecurringDepositProductsProductIdResponse
      //var instane = new ApacheFineract.GetRecurringDepositProductsProductIdResponse();
      //expect(instance).to.be.a(ApacheFineract.GetRecurringDepositProductsProductIdResponse);
    });
