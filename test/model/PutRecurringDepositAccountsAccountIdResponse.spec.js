...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new ApacheFineract.PutRecurringDepositAccountsAccountIdResponse();
  });
  ...
  describe('PutRecurringDepositAccountsAccountIdResponse', function() {
    it('should create an instance of PutRecurringDepositAccountsAccountIdResponse', function() {
      // uncomment below and update the code to test PutRecurringDepositAccountsAccountIdResponse
      //var instane = new ApacheFineract.PutRecurringDepositAccountsAccountIdResponse();
      //expect(instance).to.be.a(ApacheFineract.PutRecurringDepositAccountsAccountIdResponse);
    });
