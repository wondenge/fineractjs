...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new ApacheFineract.GetClientIdProductIdProductOptions();
  });
  ...
  describe('GetClientIdProductIdProductOptions', function() {
    it('should create an instance of GetClientIdProductIdProductOptions', function() {
      // uncomment below and update the code to test GetClientIdProductIdProductOptions
      //var instane = new ApacheFineract.GetClientIdProductIdProductOptions();
      //expect(instance).to.be.a(ApacheFineract.GetClientIdProductIdProductOptions);
    });
    ...
    it('should have the property norminalShares (base name: "norminalShares")', function() {
      // uncomment below and update the code to test the property norminalShares
      //var instane = new ApacheFineract.GetClientIdProductIdProductOptions();
      //expect(instance).to.be();
    });
    ...
    it('should have the property lockinPeriodEnum (base name: "lockinPeriodEnum")', function() {
      // uncomment below and update the code to test the property lockinPeriodEnum
      //var instane = new ApacheFineract.GetClientIdProductIdProductOptions();
      //expect(instance).to.be();
    });
