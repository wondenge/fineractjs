...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new ApacheFineract.PostSelfLoansDisbursementData();
  });
  ...
  describe('PostSelfLoansDisbursementData', function() {
    it('should create an instance of PostSelfLoansDisbursementData', function() {
      // uncomment below and update the code to test PostSelfLoansDisbursementData
      //var instane = new ApacheFineract.PostSelfLoansDisbursementData();
      //expect(instance).to.be.a(ApacheFineract.PostSelfLoansDisbursementData);
    });
