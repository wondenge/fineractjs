...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new ApacheFineract.GetLoanProductsLiabilityAccountOptions();
  });
  ...
  describe('GetLoanProductsLiabilityAccountOptions', function() {
    it('should create an instance of GetLoanProductsLiabilityAccountOptions', function() {
      // uncomment below and update the code to test GetLoanProductsLiabilityAccountOptions
      //var instane = new ApacheFineract.GetLoanProductsLiabilityAccountOptions();
      //expect(instance).to.be.a(ApacheFineract.GetLoanProductsLiabilityAccountOptions);
    });
