...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new ApacheFineract.InteropTransactionRequestResponseData();
  });
  ...
  describe('InteropTransactionRequestResponseData', function() {
    it('should create an instance of InteropTransactionRequestResponseData', function() {
      // uncomment below and update the code to test InteropTransactionRequestResponseData
      //var instane = new ApacheFineract.InteropTransactionRequestResponseData();
      //expect(instance).to.be.a(ApacheFineract.InteropTransactionRequestResponseData);
    });
