...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new ApacheFineract.PostFixedDepositProductsChartSlabs();
  });
  ...
  describe('PostFixedDepositProductsChartSlabs', function() {
    it('should create an instance of PostFixedDepositProductsChartSlabs', function() {
      // uncomment below and update the code to test PostFixedDepositProductsChartSlabs
      //var instane = new ApacheFineract.PostFixedDepositProductsChartSlabs();
      //expect(instance).to.be.a(ApacheFineract.PostFixedDepositProductsChartSlabs);
    });
