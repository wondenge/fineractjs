...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new ApacheFineract.PostAccountTransfersRequest();
  });
  ...
  describe('PostAccountTransfersRequest', function() {
    it('should create an instance of PostAccountTransfersRequest', function() {
      // uncomment below and update the code to test PostAccountTransfersRequest
      //var instane = new ApacheFineract.PostAccountTransfersRequest();
      //expect(instance).to.be.a(ApacheFineract.PostAccountTransfersRequest);
    });
