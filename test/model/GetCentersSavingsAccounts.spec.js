...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new ApacheFineract.GetCentersSavingsAccounts();
  });
  ...
  describe('GetCentersSavingsAccounts', function() {
    it('should create an instance of GetCentersSavingsAccounts', function() {
      // uncomment below and update the code to test GetCentersSavingsAccounts
      //var instane = new ApacheFineract.GetCentersSavingsAccounts();
      //expect(instance).to.be.a(ApacheFineract.GetCentersSavingsAccounts);
    });
    ...
    it('should have the property depositType (base name: "depositType")', function() {
