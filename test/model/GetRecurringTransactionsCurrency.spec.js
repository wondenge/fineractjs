...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new ApacheFineract.GetRecurringTransactionsCurrency();
  });
  ...
  describe('GetRecurringTransactionsCurrency', function() {
    it('should create an instance of GetRecurringTransactionsCurrency', function() {
      // uncomment below and update the code to test GetRecurringTransactionsCurrency
      //var instane = new ApacheFineract.GetRecurringTransactionsCurrency();
      //expect(instance).to.be.a(ApacheFineract.GetRecurringTransactionsCurrency);
    });
