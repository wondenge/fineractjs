...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new ApacheFineract.GetRecurringPaymentDetailData();
  });
  ...
  describe('GetRecurringPaymentDetailData', function() {
    it('should create an instance of GetRecurringPaymentDetailData', function() {
      // uncomment below and update the code to test GetRecurringPaymentDetailData
      //var instane = new ApacheFineract.GetRecurringPaymentDetailData();
      //expect(instance).to.be.a(ApacheFineract.GetRecurringPaymentDetailData);
    });
