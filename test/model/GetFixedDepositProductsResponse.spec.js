...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new ApacheFineract.GetFixedDepositProductsResponse();
  });
  ...
  describe('GetFixedDepositProductsResponse', function() {
    it('should create an instance of GetFixedDepositProductsResponse', function() {
      // uncomment below and update the code to test GetFixedDepositProductsResponse
      //var instane = new ApacheFineract.GetFixedDepositProductsResponse();
      //expect(instance).to.be.a(ApacheFineract.GetFixedDepositProductsResponse);
    });
