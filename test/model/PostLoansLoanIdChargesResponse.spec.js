...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new ApacheFineract.PostLoansLoanIdChargesResponse();
  });
  ...
  describe('PostLoansLoanIdChargesResponse', function() {
    it('should create an instance of PostLoansLoanIdChargesResponse', function() {
      // uncomment below and update the code to test PostLoansLoanIdChargesResponse
      //var instane = new ApacheFineract.PostLoansLoanIdChargesResponse();
      //expect(instance).to.be.a(ApacheFineract.PostLoansLoanIdChargesResponse);
    });
