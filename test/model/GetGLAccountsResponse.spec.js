...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new ApacheFineract.GetGLAccountsResponse();
  });
  ...
  describe('GetGLAccountsResponse', function() {
    it('should create an instance of GetGLAccountsResponse', function() {
      // uncomment below and update the code to test GetGLAccountsResponse
      //var instane = new ApacheFineract.GetGLAccountsResponse();
      //expect(instance).to.be.a(ApacheFineract.GetGLAccountsResponse);
    });
