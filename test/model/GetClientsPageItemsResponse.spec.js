...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new ApacheFineract.GetClientsPageItemsResponse();
  });
  ...
  describe('GetClientsPageItemsResponse', function() {
    it('should create an instance of GetClientsPageItemsResponse', function() {
      // uncomment below and update the code to test GetClientsPageItemsResponse
      //var instane = new ApacheFineract.GetClientsPageItemsResponse();
      //expect(instance).to.be.a(ApacheFineract.GetClientsPageItemsResponse);
    });
