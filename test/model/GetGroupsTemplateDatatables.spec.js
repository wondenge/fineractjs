...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new ApacheFineract.GetGroupsTemplateDatatables();
  });
  ...
  describe('GetGroupsTemplateDatatables', function() {
    it('should create an instance of GetGroupsTemplateDatatables', function() {
      // uncomment below and update the code to test GetGroupsTemplateDatatables
      //var instane = new ApacheFineract.GetGroupsTemplateDatatables();
      //expect(instance).to.be.a(ApacheFineract.GetGroupsTemplateDatatables);
    });
