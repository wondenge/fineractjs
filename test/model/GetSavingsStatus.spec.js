...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new ApacheFineract.GetSavingsStatus();
  });
  ...
  describe('GetSavingsStatus', function() {
    it('should create an instance of GetSavingsStatus', function() {
      // uncomment below and update the code to test GetSavingsStatus
      //var instane = new ApacheFineract.GetSavingsStatus();
      //expect(instance).to.be.a(ApacheFineract.GetSavingsStatus);
    });
