...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new ApacheFineract.GetLoansResponse();
  });
  ...
  describe('GetLoansResponse', function() {
    it('should create an instance of GetLoansResponse', function() {
      // uncomment below and update the code to test GetLoansResponse
      //var instane = new ApacheFineract.GetLoansResponse();
      //expect(instance).to.be.a(ApacheFineract.GetLoansResponse);
    });
