...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new ApacheFineract.GetResourceTypeResourceIdNotesResponse();
  });
  ...
  describe('GetResourceTypeResourceIdNotesResponse', function() {
    it('should create an instance of GetResourceTypeResourceIdNotesResponse', function() {
      // uncomment below and update the code to test GetResourceTypeResourceIdNotesResponse
      //var instane = new ApacheFineract.GetResourceTypeResourceIdNotesResponse();
      //expect(instance).to.be.a(ApacheFineract.GetResourceTypeResourceIdNotesResponse);
    });
