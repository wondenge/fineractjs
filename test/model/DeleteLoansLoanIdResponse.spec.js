...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new ApacheFineract.DeleteLoansLoanIdResponse();
  });
  ...
  describe('DeleteLoansLoanIdResponse', function() {
    it('should create an instance of DeleteLoansLoanIdResponse', function() {
      // uncomment below and update the code to test DeleteLoansLoanIdResponse
      //var instane = new ApacheFineract.DeleteLoansLoanIdResponse();
      //expect(instance).to.be.a(ApacheFineract.DeleteLoansLoanIdResponse);
    });
