...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new ApacheFineract.GetSurveyResponseDatatableData();
  });
  ...
  describe('GetSurveyResponseDatatableData', function() {
    it('should create an instance of GetSurveyResponseDatatableData', function() {
      // uncomment below and update the code to test GetSurveyResponseDatatableData
      //var instane = new ApacheFineract.GetSurveyResponseDatatableData();
      //expect(instance).to.be.a(ApacheFineract.GetSurveyResponseDatatableData);
    });
