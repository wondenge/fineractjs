...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new ApacheFineract.GetProductsLiabilityAccountOptions();
  });
  ...
  describe('GetProductsLiabilityAccountOptions', function() {
    it('should create an instance of GetProductsLiabilityAccountOptions', function() {
      // uncomment below and update the code to test GetProductsLiabilityAccountOptions
      //var instane = new ApacheFineract.GetProductsLiabilityAccountOptions();
      //expect(instance).to.be.a(ApacheFineract.GetProductsLiabilityAccountOptions);
    });
