...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new ApacheFineract.PostSelfAuthenticationResponse();
  });
  ...
  describe('PostSelfAuthenticationResponse', function() {
    it('should create an instance of PostSelfAuthenticationResponse', function() {
      // uncomment below and update the code to test PostSelfAuthenticationResponse
      //var instane = new ApacheFineract.PostSelfAuthenticationResponse();
      //expect(instance).to.be.a(ApacheFineract.PostSelfAuthenticationResponse);
    });
    ...
    it('should have the property base64EncodedAuthenticationKey (base name: "base64EncodedAuthenticationKey")', function() {
      // uncomment below and update the code to test the property base64EncodedAuthenticationKey
      //var instane = new ApacheFineract.PostSelfAuthenticationResponse();
      //expect(instance).to.be();
    });
