...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new ApacheFineract.GetRolesRoleIdPermissionsResponsePermissionData();
  });
  ...
  describe('GetRolesRoleIdPermissionsResponsePermissionData', function() {
    it('should create an instance of GetRolesRoleIdPermissionsResponsePermissionData', function() {
      // uncomment below and update the code to test GetRolesRoleIdPermissionsResponsePermissionData
      //var instane = new ApacheFineract.GetRolesRoleIdPermissionsResponsePermissionData();
      //expect(instance).to.be.a(ApacheFineract.GetRolesRoleIdPermissionsResponsePermissionData);
    });
