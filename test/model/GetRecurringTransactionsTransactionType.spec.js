...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new ApacheFineract.GetRecurringTransactionsTransactionType();
  });
  ...
  describe('GetRecurringTransactionsTransactionType', function() {
    it('should create an instance of GetRecurringTransactionsTransactionType', function() {
      // uncomment below and update the code to test GetRecurringTransactionsTransactionType
      //var instane = new ApacheFineract.GetRecurringTransactionsTransactionType();
      //expect(instance).to.be.a(ApacheFineract.GetRecurringTransactionsTransactionType);
    });
