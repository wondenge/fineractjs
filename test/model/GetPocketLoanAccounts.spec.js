...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new ApacheFineract.GetPocketLoanAccounts();
  });
  ...
  describe('GetPocketLoanAccounts', function() {
    it('should create an instance of GetPocketLoanAccounts', function() {
      // uncomment below and update the code to test GetPocketLoanAccounts
      //var instane = new ApacheFineract.GetPocketLoanAccounts();
      //expect(instance).to.be.a(ApacheFineract.GetPocketLoanAccounts);
    });
