...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new ApacheFineract.GetCentersCenterIdStatus();
  });
  ...
  describe('GetCentersCenterIdStatus', function() {
    it('should create an instance of GetCentersCenterIdStatus', function() {
      // uncomment below and update the code to test GetCentersCenterIdStatus
      //var instane = new ApacheFineract.GetCentersCenterIdStatus();
      //expect(instance).to.be.a(ApacheFineract.GetCentersCenterIdStatus);
    });
