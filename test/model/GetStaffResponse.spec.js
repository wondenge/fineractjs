...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new ApacheFineract.GetStaffResponse();
  });
  ...
  describe('GetStaffResponse', function() {
    it('should create an instance of GetStaffResponse', function() {
      // uncomment below and update the code to test GetStaffResponse
      //var instane = new ApacheFineract.GetStaffResponse();
      //expect(instance).to.be.a(ApacheFineract.GetStaffResponse);
    });
