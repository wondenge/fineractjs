...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new ApacheFineract.GetAccountTransfersTemplateRefundByTransferToAccount();
  });
  ...
  describe('GetAccountTransfersTemplateRefundByTransferToAccount', function() {
    it('should create an instance of GetAccountTransfersTemplateRefundByTransferToAccount', function() {
      // uncomment below and update the code to test GetAccountTransfersTemplateRefundByTransferToAccount
      //var instane = new ApacheFineract.GetAccountTransfersTemplateRefundByTransferToAccount();
      //expect(instance).to.be.a(ApacheFineract.GetAccountTransfersTemplateRefundByTransferToAccount);
    });
