...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new ApacheFineract.GetChargesResponse();
  });
  ...
  describe('GetChargesResponse', function() {
    it('should create an instance of GetChargesResponse', function() {
      // uncomment below and update the code to test GetChargesResponse
      //var instane = new ApacheFineract.GetChargesResponse();
      //expect(instance).to.be.a(ApacheFineract.GetChargesResponse);
    });
