...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new ApacheFineract.GetRecurringDepositProductsProductIdAccountingMappings();
  });
  ...
  describe('GetRecurringDepositProductsProductIdAccountingMappings', function() {
    it('should create an instance of GetRecurringDepositProductsProductIdAccountingMappings', function() {
      // uncomment below and update the code to test GetRecurringDepositProductsProductIdAccountingMappings
      //var instane = new ApacheFineract.GetRecurringDepositProductsProductIdAccountingMappings();
      //expect(instance).to.be.a(ApacheFineract.GetRecurringDepositProductsProductIdAccountingMappings);
    });
