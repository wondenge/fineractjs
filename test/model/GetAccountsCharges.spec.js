...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new ApacheFineract.GetAccountsCharges();
  });
  ...
  describe('GetAccountsCharges', function() {
    it('should create an instance of GetAccountsCharges', function() {
      // uncomment below and update the code to test GetAccountsCharges
      //var instane = new ApacheFineract.GetAccountsCharges();
      //expect(instance).to.be.a(ApacheFineract.GetAccountsCharges);
    });
