...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new ApacheFineract.GetLoansLoanIdOverdueCharges();
  });
  ...
  describe('GetLoansLoanIdOverdueCharges', function() {
    it('should create an instance of GetLoansLoanIdOverdueCharges', function() {
      // uncomment below and update the code to test GetLoansLoanIdOverdueCharges
      //var instane = new ApacheFineract.GetLoansLoanIdOverdueCharges();
      //expect(instance).to.be.a(ApacheFineract.GetLoansLoanIdOverdueCharges);
    });
    ...
    it('should have the property feeFrequency (base name: "feeFrequency")', function() {
      // uncomment below and update the code to test the property feeFrequency
      //var instane = new ApacheFineract.GetLoansLoanIdOverdueCharges();
      //expect(instance).to.be();
    });
