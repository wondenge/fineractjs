...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new ApacheFineract.GetClientsChargesPageItems();
  });
  ...
  describe('GetClientsChargesPageItems', function() {
    it('should create an instance of GetClientsChargesPageItems', function() {
      // uncomment below and update the code to test GetClientsChargesPageItems
      //var instane = new ApacheFineract.GetClientsChargesPageItems();
      //expect(instance).to.be.a(ApacheFineract.GetClientsChargesPageItems);
    });
