...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new ApacheFineract.GetClientsColumnHeaderData();
  });
  ...
  describe('GetClientsColumnHeaderData', function() {
    it('should create an instance of GetClientsColumnHeaderData', function() {
      // uncomment below and update the code to test GetClientsColumnHeaderData
      //var instane = new ApacheFineract.GetClientsColumnHeaderData();
      //expect(instance).to.be.a(ApacheFineract.GetClientsColumnHeaderData);
    });
