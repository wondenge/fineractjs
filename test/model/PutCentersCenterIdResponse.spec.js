...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new ApacheFineract.PutCentersCenterIdResponse();
  });
  ...
  describe('PutCentersCenterIdResponse', function() {
    it('should create an instance of PutCentersCenterIdResponse', function() {
      // uncomment below and update the code to test PutCentersCenterIdResponse
      //var instane = new ApacheFineract.PutCentersCenterIdResponse();
      //expect(instance).to.be.a(ApacheFineract.PutCentersCenterIdResponse);
    });
