...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new ApacheFineract.PutLoansLoanIdRequest();
  });
  ...
  describe('PutLoansLoanIdRequest', function() {
    it('should create an instance of PutLoansLoanIdRequest', function() {
      // uncomment below and update the code to test PutLoansLoanIdRequest
      //var instane = new ApacheFineract.PutLoansLoanIdRequest();
      //expect(instance).to.be.a(ApacheFineract.PutLoansLoanIdRequest);
    });
