...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new ApacheFineract.Rate();
  });
  ...
  describe('Rate', function() {
    it('should create an instance of Rate', function() {
      ...
      //var instane = new ApacheFineract.Rate();
      //expect(instance).to.be.a(ApacheFineract.Rate);
    });
    ...
    it('should have the property productApply (base name: "productApply")', function() {
      // uncomment below and update the code to test the property productApply
      //var instane = new ApacheFineract.Rate();
      //expect(instance).to.be();
    });
