...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new ApacheFineract.GetFixedDepositAccountsAccountIdResponse();
  });
  ...
  describe('GetFixedDepositAccountsAccountIdResponse', function() {
    it('should create an instance of GetFixedDepositAccountsAccountIdResponse', function() {
      // uncomment below and update the code to test GetFixedDepositAccountsAccountIdResponse
      //var instane = new ApacheFineract.GetFixedDepositAccountsAccountIdResponse();
      //expect(instance).to.be.a(ApacheFineract.GetFixedDepositAccountsAccountIdResponse);
    });
    ...
    it('should have the property interestFreePeriodApplicable (base name: "interestFreePeriodApplicable")', function() {
      // uncomment below and update the code to test the property interestFreePeriodApplicable
      //var instane = new ApacheFineract.GetFixedDepositAccountsAccountIdResponse();
      //expect(instance).to.be();
    });
