...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new ApacheFineract.PostFixedDepositAccountsResponse();
  });
  ...
  describe('PostFixedDepositAccountsResponse', function() {
    it('should create an instance of PostFixedDepositAccountsResponse', function() {
      // uncomment below and update the code to test PostFixedDepositAccountsResponse
      //var instane = new ApacheFineract.PostFixedDepositAccountsResponse();
      //expect(instance).to.be.a(ApacheFineract.PostFixedDepositAccountsResponse);
    });
