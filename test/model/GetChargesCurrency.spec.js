...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new ApacheFineract.GetChargesCurrency();
  });
  ...
  describe('GetChargesCurrency', function() {
    it('should create an instance of GetChargesCurrency', function() {
      // uncomment below and update the code to test GetChargesCurrency
      //var instane = new ApacheFineract.GetChargesCurrency();
      //expect(instance).to.be.a(ApacheFineract.GetChargesCurrency);
    });
