...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new ApacheFineract.DeleteUsersUserIdResponse();
  });
  ...
  describe('DeleteUsersUserIdResponse', function() {
    it('should create an instance of DeleteUsersUserIdResponse', function() {
      // uncomment below and update the code to test DeleteUsersUserIdResponse
      //var instane = new ApacheFineract.DeleteUsersUserIdResponse();
      //expect(instance).to.be.a(ApacheFineract.DeleteUsersUserIdResponse);
    });
